...
def calcOutage(raio, freq, posEachBs, ygrid):
    ...
    if outage >= 0.09999:
        ...
        print(
            'O maior raio que deu taxa de outage com até 10% foi: {:.2f} m '.format(raio))
...
def calcMatrizPotenciasBsdbm(raio, posEachBs, fc):
    ...
    mtPldb = 69.55+26.6*math.log10(fc)+(44.9-6.55*math.log10(HBSS))*np.log10(mtDisEachBsNorm/1e3) - \
