...
shadowingC = ((1-distY)*(Sample1*(1-distX) + Sample2*distX) +  #pt3
               distY*(Sample3*(1 - distX) + Sample4*distX))/stdNormalFactor #pt3

print('O sombreament é : {} dB'.format(shadowingC)) #pt3
#-------------------------------------------END PT.3------------------------------------------------